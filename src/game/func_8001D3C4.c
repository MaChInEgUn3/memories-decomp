...
void func_8001D3C4(Object*o)
{
 ...
 if(o->speed>=0x800){u8 target=o->target;int position=*(int*)&o->x;o->current=target;__asm__ volatile("":::"memory");o->oldPosition=position;if(!(target&0xFF))o->flags&=~4;o->active=0;o->callback=0;}
}
