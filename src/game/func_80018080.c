typedef unsigned char u8;typedef unsigned short u16;typedef struct{char p[8];u16 flags;char pA[2];int color;char p10[6];u16 eflags;char p18[9];u8 a,b;char p23[0x44];u8 mark;char p68[2];u8 index;}Obj;
