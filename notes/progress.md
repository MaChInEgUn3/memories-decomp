...
| Remaining game assembly functions | 531 |
| Remaining game assembly-function bytes | 299,560 (`0x49228`) |
| Embedded/unassigned text bytes | 1,780 (`0x6F4`) |
| Matching C functions | 600 |
| Matching C bytes | 50,416 (`0xC4F0`) |
...
All 600 matching functions currently use the GCC 2.8.1 PSX probe:

| Compiler profile | Functions |
|---|---:|
| `gcc_2_8_1_g8` | 314 |
| `gcc_2_8_1_g8_split` | 61 |
| `gcc_2_8_1_g0` | 188 |
| `gcc_2_8_1_g0_split` | 37 |

The attempt ledger currently records 2,690 outcomes: 600 matches, 1,846
nonmatches, and 244 deferred functions whose six-attempt search budgets are
