...
- Five hundred six game functions totaling 32,160 bytes (`0x7DA0`) are
  matching C using the GCC 2.8.1 probe. Six hundred twenty-five
  compiler-generated game functions totaling 317,816 bytes (`0x4D978`) remain
