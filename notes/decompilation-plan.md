...
- Four hundred fifteen game functions totaling 21,364 bytes (`0x5374`) are
  matching C using the GCC 2.8.1 probe. Seven hundred sixteen
  compiler-generated game functions totaling 328,612 bytes (`0x503A4`) remain
