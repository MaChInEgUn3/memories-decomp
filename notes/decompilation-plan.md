...
- Five hundred sixty-one game functions totaling 41,112 bytes (`0xA098`) are
  matching C using the GCC 2.8.1 probe. Five hundred seventy compiler-generated
  game functions totaling 308,864 bytes (`0x4B680`) remain
