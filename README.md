...
| Metric | Current |
|---|---:|
| Matching C functions | **813 / 1,196 (67.98%)** |
| Matching C bytes | **101,328 (`0x18BD0`) / 396,212 (`0x60BB4`) (25.57%)** |
| Remaining compiler-generated game assembly | 320 functions, 248,648 (`0x3CB48`) |
...
| `main_menu` | 7 / 31 (22.58%) | 788 (`0x314`) / 17,724 (`0x453C`) (4.45%) |
...
| `password` | 9 / 27 (33.33%) | 1,024 (`0x400`) / 10,884 (`0x2A84`) (9.41%) |
