...
| Metric | Current |
|---|---:|
| Matching C functions | **790 / 1,196 (66.05%)** |
| Matching C bytes | **97,068 (`0x17B2C`) / 396,212 (`0x60BB4`) (24.50%)** |
| Remaining compiler-generated game assembly | 343 functions, 252,908 (`0x3DBEC`) |
