...
| Metric | Current |
|---|---:|
| Matching C functions | **791 / 1,196 (66.14%)** |
| Matching C bytes | **97,164 (`0x17B8C`) / 396,212 (`0x60BB4`) (24.52%)** |
| Remaining compiler-generated game assembly | 342 functions, 252,812 (`0x3DB8C`) |
