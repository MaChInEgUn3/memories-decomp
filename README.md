...
| Metric | Current |
|---|---:|
| Matching C functions | **800 / 1,196 (66.89%)** |
| Matching C bytes | **99,604 (`0x18514`) / 396,212 (`0x60BB4`) (25.14%)** |
| Remaining compiler-generated game assembly | 333 functions, 250,372 (`0x3D204`) |
...
| `overworld_after_coup` | 0 / 20 (0.00%) | 0 (`0x0`) / 6,180 (`0x1824`) (0.00%) |
| `overworld_before_coup` | 0 / 20 (0.00%) | 0 (`0x0`) / 6,180 (`0x1824`) (0.00%) |
| `password` | 4 / 27 (14.81%) | 292 (`0x124`) / 10,884 (`0x2A84`) (2.68%) |
